...
class AgentExecution(Base, UUIDMixin, TimestampMixin):
    ...
    # Data
    input_data: Mapped[dict[str, Any] | None] = mapped_column(JSON_VARIANT, nullable=True)
    output_data: Mapped[dict[str, Any] | None] = mapped_column(JSON_VARIANT, nullable=True)
